...
Write-Host "🧠 Ensemble Brain Stroke Detection" -ForegroundColor Green
Write-Host "===================================" -ForegroundColor Green
Write-Host "Using test-time augmentation for better reliability" -ForegroundColor Yellow
...
Write-Host "Running ensemble prediction..." -ForegroundColor Yellow
python -m src.ensemble_predict $ImagePath --checkpoint $CheckpointPath --config $ConfigPath --use_pretrained
